...
mixin _$CartState {
  ...
  @override
  String toString() {
    return 'CartState(totalItemCount: $totalItemCount, totalPrice: $totalPrice, productMap: $productMap, productList: $productList, selectedDistributorIds: $selectedDistributorIds)';
  }
}
