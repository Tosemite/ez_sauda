...
mixin _$SearchState {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, category, brand, query, total,
      const DeepCollectionEquality().hash(products));

  @override
  String toString() {
    return 'SearchState(category: $category, brand: $brand, query: $query, total: $total, products: $products)';
  }
}
