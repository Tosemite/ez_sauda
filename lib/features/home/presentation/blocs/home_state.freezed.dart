...
mixin _$HomeState {
  ...
  @override
  String toString() {
    return 'HomeState(categories: $categories, recommendedProducts: $recommendedProducts)';
  }
}
...
abstract mixin class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Category>? categories, List<Product>? recommendedProducts});
}
    ...
    return _then(HomeState(
      categories: freezed == categories
          ...
          : categories // ignore: cast_nullable_to_non_nullable
              as List<Category>?,
      recommendedProducts: freezed == recommendedProducts
